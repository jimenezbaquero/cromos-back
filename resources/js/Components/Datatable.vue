              ...
              <div class="flex items-center px-2 py-1 rounded w-full max-w-sm">
                ...
                <template v-if="column.sortable">
                  <div @click="sortBy(column)" class="cursor-pointer justify-end w-10 ">
                    <svg v-if = "filters[index].sort === 'asc'" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5 12 3m0 0 7.5 7.5M12 3v18" />
                    </svg>
                    
                    <svg v-else-if = "filters[index].sort === 'desc'"xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
